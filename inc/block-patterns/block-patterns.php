...
if ( ! function_exists( 'cormorant_register_block_patterns' ) ) {
	function cormorant_register_block_patterns() {
		...
		uasort( $cormorant_block_pattern_categories, function ( $a, $b ) {
		...
		$viewport = apply_filters( 'cormorant_block_patterns_viewport', array(
			'full'         => 1440,
			'wide'         => 1312,
			'wide_grouped' => 1180,
			'content'      => 640
		...
		$cormorant_block_patterns = apply_filters( 'cormorant_block_patterns', array(
