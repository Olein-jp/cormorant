<?php
/**
 * Title: CTA Horizontal Primary
 * Slug: cormorant/cta-horizontal-primary
 * Categories: cormorant-cta
 * Description: Call To Action layout Horizontal colored primary
 * Keywords: cormorant
 ...
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|m","right":"var:preset|spacing|60","bottom":"var:preset|spacing|l","left":"var:preset|spacing|60"},"blockGap":"0"}},"backgroundColor":"primary","textColor":"background","layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":3} -->
		...
		<div class="wp-block-columns are-vertically-aligned-center" style="margin-top:var(--wp--preset--spacing--x-small)"><!-- wp:column {"verticalAlignment":"center","width":"66.66%"} -->
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:33.33%"><!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"},"style":{"spacing":{"blockGap":"0"}},"fontSize":"medium"} -->
				<div class="wp-block-buttons has-custom-font-size has-medium-font-size"><!-- wp:button {"className":"is-style-cormorant-background-outline-square-button","fontSize":"s"} -->
					<div class="wp-block-button has-custom-font-size is-style-cormorant-background-outline-square-button has-s-font-size"><a class="wp-block-button__link wp-element-button">Contact Us</a></div>
					<!-- /wp:button --></div>
				<!-- /wp:buttons --></div>
			<!-- /wp:column --></div>
		<!-- /wp:columns --></div>
