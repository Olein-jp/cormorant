<?php
/**
 * Title: Picture on Card Testimonial
 * Slug: cormorant/testimonial/picture-on-card
 * Categories: cormorant-testimonial
 * Description: Picture on card testimonial
 * Keywords: cormorant
...
<section class="wp-block-group has-background" style="background:linear-gradient(150deg,rgb(238,238,238) 46%,rgb(255,255,255) 46%);padding-top:var(--wp--preset--spacing--3-xl);padding-bottom:var(--wp--preset--spacing--3-xl)"><!-- wp:group {"tagName":"header","style":{"spacing":{"blockGap":"var:preset|spacing|xs","margin":{"bottom":"var:preset|spacing|xl"}}},"layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-group"><!-- wp:columns -->
		<div class="wp-block-columns"><!-- wp:column -->
			<div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|m","padding":{"top":"var:preset|spacing|xl","bottom":"var:preset|spacing|xl","left":"var:preset|spacing|m","right":"var:preset|spacing|m"}}},"backgroundColor":"contrast","textColor":"base","className":"is-style-cormorant-blur-shadow-group","layout":{"type":"constrained"}} -->
				<div class="wp-block-group is-style-cormorant-blur-shadow-group has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--xl);padding-right:var(--wp--preset--spacing--m);padding-bottom:var(--wp--preset--spacing--xl);padding-left:var(--wp--preset--spacing--m)"><!-- wp:group {"layout":{"type":"constrained"}} -->
					<div class="wp-block-group"><!-- wp:image {"align":"center","id":3219,"width":120,"sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"100px","width":"3px"}},"borderColor":"lighter-gray","className":"is-style-cormorant-blur-shadow-image"} -->
						<figure class="wp-block-image aligncenter size-full is-resized has-custom-border is-style-cormorant-blur-shadow-image"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/cormorant-sample-12.jpg' ); ?>" alt="" class="has-border-color has-lighter-gray-border-color wp-image-3219" style="border-width:3px;border-radius:100px;width:120px" width="120"/></figure>
						<!-- /wp:image --></div>
					<!-- /wp:group -->
			...
			<div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|m","padding":{"top":"var:preset|spacing|xl","bottom":"var:preset|spacing|xl","left":"var:preset|spacing|m","right":"var:preset|spacing|m"}}},"backgroundColor":"contrast","textColor":"base","className":"is-style-cormorant-blur-shadow-group","layout":{"type":"constrained"}} -->
				<div class="wp-block-group is-style-cormorant-blur-shadow-group has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--xl);padding-right:var(--wp--preset--spacing--m);padding-bottom:var(--wp--preset--spacing--xl);padding-left:var(--wp--preset--spacing--m)"><!-- wp:group {"layout":{"type":"constrained"}} -->
					<div class="wp-block-group"><!-- wp:image {"align":"center","id":3218,"width":120,"sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"100px","width":"3px"}},"borderColor":"lighter-gray","className":"is-style-cormorant-blur-shadow-image"} -->
						<figure class="wp-block-image aligncenter size-full is-resized has-custom-border is-style-cormorant-blur-shadow-image"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/cormorant-sample-11.jpg' ); ?>" alt="" class="has-border-color has-lighter-gray-border-color wp-image-3218" style="border-width:3px;border-radius:100px;width:120px" width="120"/></figure>
						<!-- /wp:image --></div>
					<!-- /wp:group -->
			...
			<div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|m","padding":{"top":"var:preset|spacing|xl","bottom":"var:preset|spacing|xl","left":"var:preset|spacing|m","right":"var:preset|spacing|m"}}},"backgroundColor":"contrast","textColor":"base","className":"is-style-cormorant-blur-shadow-group","layout":{"type":"constrained"}} -->
				<div class="wp-block-group is-style-cormorant-blur-shadow-group has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--xl);padding-right:var(--wp--preset--spacing--m);padding-bottom:var(--wp--preset--spacing--xl);padding-left:var(--wp--preset--spacing--m)"><!-- wp:group {"layout":{"type":"constrained"}} -->
					<div class="wp-block-group"><!-- wp:image {"align":"center","id":3206,"width":120,"sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"100px","width":"3px"}},"borderColor":"lighter-gray","className":"is-style-cormorant-blur-shadow-image"} -->
						<figure class="wp-block-image aligncenter size-full is-resized has-custom-border is-style-cormorant-blur-shadow-image"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/cormorant-sample-10.jpg' ); ?>" alt="WordPress 100%GPL Block Theme Cormorant Sample Image 10" class="has-border-color has-lighter-gray-border-color wp-image-3206" style="border-width:3px;border-radius:100px;width:120px" width="120"/></figure>
						<!-- /wp:image --></div>
					<!-- /wp:group -->
